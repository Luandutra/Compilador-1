...
public class tabela { 
    ...
    public Map<String, Map<String, Integer>> mapaTabela(){
        ...
        tabelaSintatica.put("TK_inicio", tabela_Inicio);
        
        Map<String, Integer> tabela_Fim = new HashMap<>();
        tabela_Fim.put("LISTA_COMANDOS", 2);
        tabelaSintatica.put("TK_fim", tabela_Fim);
        ...
        tabelaSintatica.put("TK_fimbloco", tabela_fimBloco);
        ...
        tabelaSintatica.put("TK_leia", tabela_leia);
        ...
        tabelaSintatica.put("TK_escreva", tabela_escreva);
        ...
        tabelaSintatica.put("TK_numpos", tabela_numpos);
        ...
        tabelaSintatica.put("TK_numneg", tabela_numneg);
        ...
        tabelaSintatica.put("TK_variavel", tabela_variavel);
